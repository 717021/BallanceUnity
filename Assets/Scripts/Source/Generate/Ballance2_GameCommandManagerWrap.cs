...
public class Ballance2_GameCommandManagerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Ballance2.GameCommandManager), typeof(UnityEngine.MonoBehaviour));
	...
	static int Log(IntPtr L)
	{
		try
		{
			...
			Ballance2.GameCommandManager obj = (Ballance2.GameCommandManager)ToLua.CheckObject<Ballance2.GameCommandManager>(L, 1);
	...
	static int OutPutError(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Ballance2.GameCommandManager.OutPutError");
			}
		}
		catch (Exception e)
		{
	...
	static int OutPutWarn(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Ballance2.GameCommandManager.OutPutWarn");
			}
		}
		catch (Exception e)
		{
	...
	static int OutPutInfo(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Ballance2.GameCommandManager.OutPutInfo");
			}
		}
		catch (Exception e)
		{
	...
	static int RegisterCommand(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				...
				Ballance2.GameCommandManager.CommandReceiverHandler arg1 = (Ballance2.GameCommandManager.CommandReceiverHandler)ToLua.CheckDelegate<Ballance2.GameCommandManager.CommandReceiverHandler>(L, 2);
				bool o = Ballance2.GameCommandManager.RegisterCommand(arg0, arg1);
			...
			else if (count == 3)
			{
				...
				bool o = Ballance2.GameCommandManager.RegisterCommand(arg0, arg1, arg2);
				LuaDLL.lua_pushboolean(L, o);
				return 1;
			}
			else if (count == 4)
			{
				...
				bool o = Ballance2.GameCommandManager.RegisterCommand(arg0, arg1, arg2, arg3);
				LuaDLL.lua_pushboolean(L, o);
				return 1;
			}
			else if (count == 5)
			{
				...
				bool o = Ballance2.GameCommandManager.RegisterCommand(arg0, arg1, arg2, arg3, arg4);
				LuaDLL.lua_pushboolean(L, o);
				return 1;
			}
			else if (count == 6)
			{
				...
				string arg3 = ToLua.CheckString(L, 4);
				int arg4 = (int)LuaDLL.luaL_checknumber(L, 5);
				Ballance2.GameCommandManager.CommandReceiverHandler arg5 = (Ballance2.GameCommandManager.CommandReceiverHandler)ToLua.CheckDelegate<Ballance2.GameCommandManager.CommandReceiverHandler>(L, 6);
				bool o = Ballance2.GameCommandManager.RegisterCommand(arg0, arg1, arg2, arg3, arg4, arg5);
				LuaDLL.lua_pushboolean(L, o);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Ballance2.GameCommandManager.RegisterCommand");
			}
		}
		catch (Exception e)
		{
	...
	static int IsCommandRegistered(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			bool o = Ballance2.GameCommandManager.IsCommandRegistered(arg0);
			LuaDLL.lua_pushboolean(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int UnRegisterCommand(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			Ballance2.GameCommandManager.CommandReceiverHandler arg1 = (Ballance2.GameCommandManager.CommandReceiverHandler)ToLua.CheckDelegate<Ballance2.GameCommandManager.CommandReceiverHandler>(L, 2);
			bool o = Ballance2.GameCommandManager.UnRegisterCommand(arg0, arg1);
			LuaDLL.lua_pushboolean(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int SetCurrentCommandResult(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			Ballance2.GameCommandManager.SetCurrentCommandResult(arg0);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int get_DisplayInfoUi(IntPtr L)
	{
		...
		try
		{
			...
			Ballance2.GameCommandManager obj = (Ballance2.GameCommandManager)o;
			Ballance2.UI.Components.DisplayInfoUi ret = obj.DisplayInfoUi;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_dragCommand(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Ballance2.GameCommandManager obj = (Ballance2.GameCommandManager)o;
			Ballance2.UI.Utils.DUIDrag ret = obj.dragCommand;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_cmdlinesDUIRayIgnore(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Ballance2.GameCommandManager obj = (Ballance2.GameCommandManager)o;
			Ballance2.UI.Utils.DUIRayIgnore ret = obj.cmdlinesDUIRayIgnore;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_textLinesDUIRayIgnore(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Ballance2.GameCommandManager obj = (Ballance2.GameCommandManager)o;
			Ballance2.UI.Utils.DUIRayIgnore ret = obj.textLinesDUIRayIgnore;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_Instance(IntPtr L)
	{
		try
		{
			ToLua.Push(L, Ballance2.GameCommandManager.Instance);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_DisplayInfoUi(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Ballance2.GameCommandManager obj = (Ballance2.GameCommandManager)o;
			Ballance2.UI.Components.DisplayInfoUi arg0 = (Ballance2.UI.Components.DisplayInfoUi)ToLua.CheckObject<Ballance2.UI.Components.DisplayInfoUi>(L, 2);
	...
	static int set_dragCommand(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Ballance2.GameCommandManager obj = (Ballance2.GameCommandManager)o;
			Ballance2.UI.Utils.DUIDrag arg0 = (Ballance2.UI.Utils.DUIDrag)ToLua.CheckObject<Ballance2.UI.Utils.DUIDrag>(L, 2);
	...
	static int set_cmdlinesDUIRayIgnore(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Ballance2.GameCommandManager obj = (Ballance2.GameCommandManager)o;
			Ballance2.UI.Utils.DUIRayIgnore arg0 = (Ballance2.UI.Utils.DUIRayIgnore)ToLua.CheckObject<Ballance2.UI.Utils.DUIRayIgnore>(L, 2);
