...
public class GlobalUI_UIPageWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(GlobalUI.UIPage), typeof(UnityEngine.MonoBehaviour));
	...
	static int Show(IntPtr L)
	{
		try
		{
			...
			GlobalUI.UIPage obj = (GlobalUI.UIPage)ToLua.CheckObject<GlobalUI.UIPage>(L, 1);
			obj.Show();
			return 0;
		}
		catch (Exception e)
	...
	static int get_Address(IntPtr L)
	{
		...
		try
		{
			...
			GlobalUI.UIPage obj = (GlobalUI.UIPage)o;
