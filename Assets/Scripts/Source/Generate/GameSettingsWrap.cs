...
public class GameSettingsWrap
{
	...
	static int GetSettingsString(IntPtr L)
	{
		try
		{
			...
			string o = GameSettings.GetSettingsString(arg0);
	...
	static int SetSettingsString(IntPtr L)
	{
		try
		{
			...
			GameSettings.SetSettingsString(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int GetSettingsBool(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			bool o = GameSettings.GetSettingsBool(arg0);
	...
	static int SetSettingsBool(IntPtr L)
	{
		try
		{
			...
			GameSettings.SetSettingsBool(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int GetSettingsInt(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			int o = GameSettings.GetSettingsInt(arg0);
	...
	static int SetSettingsInt(IntPtr L)
	{
		try
		{
			...
			GameSettings.SetSettingsInt(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int GetSettingsFloat(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			float o = GameSettings.GetSettingsFloat(arg0);
	...
	static int SetSettingsFloat(IntPtr L)
	{
		try
		{
			...
			GameSettings.SetSettingsFloat(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
