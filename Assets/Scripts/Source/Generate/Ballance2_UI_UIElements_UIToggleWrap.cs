...
public class Ballance2_UI_UIElements_UIToggleWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Ballance2.UI.UIElements.UIToggle), typeof(Ballance2.UI.UIElement));
	...
	static int OnClick(IntPtr L)
	{
		try
		{
			...
			Ballance2.UI.UIElements.UIToggle obj = (Ballance2.UI.UIElements.UIToggle)ToLua.CheckObject<Ballance2.UI.UIElements.UIToggle>(L, 1);
			obj.OnClick();
			return 0;
		}
		catch (Exception e)
	...
	static int get_isChecked(IntPtr L)
	{
		...
		try
		{
			...
			Ballance2.UI.UIElements.UIToggle obj = (Ballance2.UI.UIElements.UIToggle)o;
	...
	{
		ToLua.Push(L, new EventObject(typeof(Ballance2.UI.UIElements.UIToggle.VoidDelegate)));
		return 1;
	}
	...
	static int set_onCheckChanged(IntPtr L)
	{
		try
		{
			Ballance2.UI.UIElements.UIToggle obj = (Ballance2.UI.UIElements.UIToggle)ToLua.CheckObject(L, 1, typeof(Ballance2.UI.UIElements.UIToggle));
			...
			{
				return LuaDLL.luaL_throw(L, "The event 'Ballance2.UI.UIElements.UIToggle.onCheckChanged' can only appear on the left hand side of += or -= when used outside of the type 'Ballance2.UI.UIElements.UIToggle'");
			}

			if (arg0.op == EventOp.Add)
			{
				Ballance2.UI.UIElements.UIToggle.VoidDelegate ev = (Ballance2.UI.UIElements.UIToggle.VoidDelegate)arg0.func;
